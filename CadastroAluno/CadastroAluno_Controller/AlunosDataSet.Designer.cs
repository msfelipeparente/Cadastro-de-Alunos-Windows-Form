...
namespace CadastroAluno_Controller {
    ...
    public partial class AlunosDataSet : global::System.Data.DataSet {
        ...
        public partial class AlunosDataTable : global::System.Data.TypedTableBase<AlunosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public AlunosRow AddAlunosRow(string Nome, string RG, string CPF) {
...
namespace CadastroAluno_Controller.AlunosDataSetTableAdapters {
    ...
    public partial class AlunosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Alunos` WHERE ((`id` = ?) AND ((? = 1 AND `Nome` IS NULL) OR (`Nome`" +
                " = ?)) AND ((? = 1 AND `RG` IS NULL) OR (`RG` = ?)) AND ((? = 1 AND `CPF` IS NUL" +
                "L) OR (`CPF` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Alunos` (`Nome`, `RG`, `CPF`) VALUES (?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Alunos` SET `Nome` = ?, `RG` = ?, `CPF` = ? WHERE ((`id` = ?) AND ((? = 1" +
                " AND `Nome` IS NULL) OR (`Nome` = ?)) AND ((? = 1 AND `RG` IS NULL) OR (`RG` = ?" +
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CadastroAluno_Controller.Properties.Settings.Default.AlunosConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, Nome, RG, CPF FROM Alunos";
